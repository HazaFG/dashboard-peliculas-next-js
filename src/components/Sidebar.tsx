        ...
        <div>
          ...
          <div className="mt-8 text-center">
            <Image
              ...
              width={112} // lg:w-28 means 28 * 4 = 112px
              height={112} // lg:h-28 means 28 * 4 = 112px
            />
          ...
          <ul className="space-y-2 tracking-wide mt-8">
            <li>
              ...
              <Link href="/dashboard" aria-label="dashboard" className="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
            ...
            <li>
              <Link href="/categories" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
            ...
            <li>
              <Link href="/reports" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li>
              <Link href="/other-data" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li>
              <Link href="/finance" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
